      ...
      <div className="w-full max-w-6xl px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            Welcome to [Your Website Name], your go-to platform for the latest and most relevant news across various categories. Our mission is to provide timely, accurate, and engaging content that keeps you informed about the world around you.
...
At [Your Website Name], we believe in delivering news that is factual, well-researched, and insightful. Whether you're a tech enthusiast, a business professional, or someone who simply loves staying updated, our platform has something for everyone.
            </p>
          </div>
