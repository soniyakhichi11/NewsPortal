        ...
        to={`/search?category=${post && post.category}`} 
         ...
         <img src={post && post.image}
          ...
          <div className='flex justify-between p-3 mx-auto w-full max-w-2xl text-xs'>
            ...
            <span className='italic'>{post && (post.content.length/100).toFixed(0)} mins read

            </span>
          </div>
          <Separator className="bg-slate-500"></Separator>
          <div className='p-3 max-w-3xl mx-auto w-full' dangerouslySetInnerHTML={{__html: post && post.content}}>
          </div>

          <div className='max-w-4xl mx-auto w-'></div>
    </main>
  )
}
