...
import { updateFailure,updateSuccess,updateStart, deleteUserStart, deleteUserFailure } from '@/redux/user/userSlice'
    ...
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={handleDeleteUser} classname="bg-red-600">Continue</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
